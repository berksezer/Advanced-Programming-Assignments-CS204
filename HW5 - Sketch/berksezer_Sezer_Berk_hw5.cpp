...
int main(){
  ...
  FreqSketch* sketch_arr[9];
 
  sketch_arr[0] = new CountMinSketch(0.01, 0.003,0);
  
  cout << "--> It is a Count-Min Sketch!"<< endl; 

  sketch_arr[1] = new CountMinMeanSketch(0.01, 0.003,1);
  
  cout << "--> It is Count-Min-Mean Sketch!" << endl;

  sketch_arr[2] = new CountSketch(0.01, 0.003,2);
  
  cout << "--> It is a Count Sketch!" << endl;

  sketch_arr[3] = new CountMinSketch(0.001, 0.003,3);
  
  cout << "--> It is a Count-Min Sketch!"<< endl; 

  sketch_arr[4] = new CountMinMeanSketch(0.001, 0.003,4);
  
  cout << "--> It is Count-Min-Mean Sketch!" << endl;

  sketch_arr[5] = new CountSketch(0.001, 0.003,5);
 
    cout << "--> It is a Count Sketch!" << endl;

  sketch_arr[6] = new CountMinSketch(0.001, 0.00001,6);

  cout << "--> It is a Count-Min Sketch!"<< endl; 

  sketch_arr[7] = new CountMinMeanSketch(0.001, 0.00001,7);
  
  cout << "--> It is Count-Min-Mean Sketch!" << endl;

  sketch_arr[8] = new CountSketch(0.001, 0.00001,8);
